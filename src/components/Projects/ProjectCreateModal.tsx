...
interface Props {
  open: boolean;
  onClose: () => void;
  onSubmit: (project: Omit<Project, 'id' | 'createdAt' | 'updatedAt' | 'createdById' | 'requirement'>) => void;
  isLoading: boolean;
}
      ...
      <div className="p-2">
        <form onSubmit={handleSubmit} className="space-y-6">
          <fieldset>
            ...
            <div className="mt-4">
              <label htmlFor="techStackContext" className="block text-sm font-medium text-gray-700 mb-1">
                Tech Stack <span className="text-red-500">*</span>
              </label>
              <textarea
                id="techStackContext"
                name="techStackContext"
                value={form.techStackContext}
                onChange={handleChange}
